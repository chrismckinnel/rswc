...
<head>
    ...
    <!-- end JS -->
	<title>Resource Solutions West Coast - About Us</title>
</head>
...
<div id="wrap">
    ...
    <section id="content" class="container clearfix">
        ...
        <header id="page-header">
            <h1 id="page-title">Phil McKinnel (BSc, BCom)</h1>	
        </header>
        <!-- end page header -->
        ...
        <section>
            <div class="team-member">
                <img class="photo" src="images/contact/phil.jpg" alt="Team Member">
                <div class="content">
