...
<head>
	...
	<title>Resource Solutions West Coast - Dairy</title>
</head>
...
<div id="wrap">
    ...
    <section id="content" class="container clearfix">
        ...
        <p>RSWC has a relationship with a Certified Effluent Management contractor and can provide project management services to any upgrades you are planning on undertaking.</p>
    
        <p>For more information in relation to the above services <a href="contact.php">get in touch</a>.</p>
        <!-- end main content -->
    </section>
    <!-- end content -->
